...
User → Nginx (:80) → OpenWebUI (:8080 internal, :3000 host)
              ...
              PPTX Service (:8000 internal)   ← (phase-11, planned) python-pptx + LiteLLM → .pptx
